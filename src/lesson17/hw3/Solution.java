...
//        String internetAddress = "http://gromcode.com";
    ...
    public static String mostCountedWord(String input) {
        ...
        //Если слов не найденно, а соответсвенно значение tempString осталось пустым - возвращаем
        // любое слово (первое слово из массивас строк), в противном случае возвращаем tempString
        if (tempString == "") {
            return strings[0];
        }
        return tempString;
